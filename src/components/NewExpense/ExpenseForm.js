...
const ExpenseForm = () => {
    ...
    const titleChangeHandler = (event) => {
        ...
        // This aproach will ensure you get the latest state
        // when values depends of previou stated
    ...
    const amountChangeHandler = (event) => {
        ...
        //This aprouch is when the values don't depends of previous states values
        /*setUserInput({
            ...userInput,
